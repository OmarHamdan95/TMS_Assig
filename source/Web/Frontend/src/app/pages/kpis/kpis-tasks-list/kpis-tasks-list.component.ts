...
@Component({
    selector: "app-kpis-tasks-list",
    templateUrl: "./kpis-tasks-list.component.html",
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
...
export class AppKpisTasksListComponent {
    ...
    load () {
        this.appKpiService.tasks(this.grid.parameters).subscribe((grid: any) => {
            this.grid = grid;
