...
namespace AjKpi.Database.Persistence.Migrations
{
    ...
    [Migration("20241226231602_AddParentKpi")]
    partial class AddParentKpi
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AjKpi.Domain.Kpi", b =>
                {
                    ...
                    b.Property<long?>("ParentKpiId")
                        .HasColumnType("bigint")
                        .HasColumnName("PARENT_KPI_ID");

                    b.Property<decimal?>("Percantage")
                        .HasColumnType("numeric")
                        .HasColumnName("PERCANTAGE");

                    b.Property<long?>("PolarityId")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AjKpi.Domain.Kpi", b =>
                {
                    ...
                    b.HasOne("AjKpi.Domain.Kpi", "ParentKpi")
                        .WithMany()
                        .HasForeignKey("ParentKpiId");

                    b.HasOne("AjKpi.Domain.LookupValue", "Polarity")
                        .WithMany()
                        .HasForeignKey("PolarityId");
                    ...
                    b.HasOne("AjKpi.Domain.LookupValue", "SustainableDevelopmentGoal")
                        .WithMany()
                    ...
                    b.Navigation("ParentKpi");

                    b.Navigation("Polarity");
